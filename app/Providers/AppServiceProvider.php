...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        FilamentIcon::register([
            ...
            'forms::components.toggle-buttons.boolean.false' => 'ri-close-line',
            'forms::components.toggle-buttons.boolean.true' => 'ri-check-line',
            ...
            'tables::columns.icon-column.false' => 'ri-close-line',
            'tables::columns.icon-column.true' => 'ri-check-line',
            ...
            'tables::header-cell.sort-button' => 'ri-swap-line',
