    ...
    <div class="s-pt-100">
        <div class="container-fluid">
            <div
                ...
                <div
                    ...
                    <div>
                        ...
                        <ul class="text-white leading-none flex flex-col gap-4">
                            <li class="duration-100 hover:text-primary inline-block group">
                                <a class="text-underline-primary" href="about.php">
                                    Home
                                </a>
                            </li>
                            <li class="duration-100 hover:text-primary inline-block group">
                                <a class="text-underline-primary" href="team.php">
                                    Shop
                                </a>
                            </li>
                            <li class="duration-100 hover:text-primary inline-block group">
                                <a class="text-underline-primary" href="portfolio-v1.php">
                                    Contact
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul class="text-white leading-none flex flex-col gap-4">
                            ...
                            <li class="duration-100 hover:text-primary inline-block group">
                                <a class="text-underline-primary" href="my-profile.php">Login/Register</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <ul class="text-white leading-none flex flex-col gap-4">
                            <li class="duration-100 hover:text-primary inline-block group">
                                <a class="text-underline-primary" href="shop-v1.php">
                                    +639 123 456 7890
                                </a>
                            </li>
                            <li class="duration-100 hover:text-primary inline-block group">
                                <a class="text-underline-primary" href="product-details.php">
                                    +639 123 456 7890
                                </a>
                            </li>
                            <li class="duration-100 hover:text-primary inline-block group">
                                <a class="text-underline-primary" href="cart.php">
                                    inquiry@placeperfect.com
                                </a>
                            </li>
                            <li class="duration-100 hover:text-primary inline-block group">
                                <a class="text-underline-primary" href="checkout.php">
                                    career@placeperfect.com
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="max-w-[1722px] mx-auto border-t border-white border-opacity-10 py-5 md:py-7 text-center">
                <p class="mb-0 text-gray-300">© {{ date('Y') }}, {{ config('app.name') }} All Rights Reserved.</p>
            </div>
        </div>
    </div>
</div>
