<div>
    <x-shop.section title="Order Placed">
        <div class="max-w-[710px] mx-auto text-center bg-success dark:bg-dark-secondary p-7 sm:p-10 lg:p-12">
            ...
            <div class="mt-3 text-base sm:text-lg text-paragraph dark:text-white">
                <div class="alert alert-info" role="alert">
                    <h5 class="mb-2"><i class="fas fa-phone"></i> Thank You for Your Order!</h5>
                    <p class="mb-2">We've received your order. Our staff will call you within 24-48 business hours
                        to discuss payment and delivery.</p>
            ...
            <a href="{{ route('customer.order') }}" class="btn btn-solid mt-4 md:mt-6" data-text="View Order">
                <span>
                    View Order
                </span>
            </a>
