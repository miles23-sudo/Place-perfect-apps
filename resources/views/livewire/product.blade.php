                            ...
                            <div class="pro-details-wishlist">
                                ...
                                @if ($this->product->ar_image)
                                    <model-viewer id="chairViewer"
                                        ...
                                        alt="{{ $this->product->name }}" ar ar-placement="floor" ar-scale="fixed"
                                        ar-modes="webxr scene-viewer" camera-controls disable-pan disable-tap
                                        disable-zoom auto-rotate reveal="auto" shadow-intensity="1" shadow-softness="1"
                                        max-camera-orbit="auto 90deg auto" touch-action="pan-y" exposure="1">

                                        <a href="javascript:;" slot="ar-button">
                                            <i class="icon-eye"></i> View in AR
                                        </a>

                                        <div id="ar-failure"></div>
                                        <div id="ar-status-message"></div>
                                        <div id="dimension-label" style="display: none;">Width: 10cm | Height: 40cm |
                                            Depth: 30cm</div>
                                    </model-viewer>
                                @endif
                            </div>
