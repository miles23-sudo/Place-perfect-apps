<div>
        ...
        <div
            ...
            <div class="max-w-[1720px] mx-auto">
                <div class="absolute top-5 right-[30%] z-10 hidden lg:block shape-01">
                    <svg class="w-[300px] xl:w-[500px] h-[250px] xl:h-[409px]" viewBox="0 0 501 410" fill="none"
            ...
            <div class="max-w-[1720px] mx-auto">
                ...
                <div class="flex flex-col items-center justify-between gap-8 sm:flex-row">
                    <div class="relative z-10 sm:max-w-[632px] w-full slider-content">
                        <h2
                            class="mt-[10px] font-normal text-3xl sm:text-4xl xl:text-5xl !leading-[1.3] dark:text-white">
                            Exciting New Arrivals Unmissable Just Landed</h2>
    ...
    <div class="s-py-50-100">
        <div class="container-fluid">
            ...
            <div class="max-w-[1720px] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-8"
            ...
            <div class="text-center mt-7 md:mt-12">
                <a href="{{ route('shop') }}" class="btn btn-outline" data-text="All Products">
