<x-layouts.app>
    <x-shop.section title="Payment Success">
        <div class="max-w-[710px] mx-auto text-center bg-success dark:bg-dark-secondary p-7 sm:p-10 lg:p-12">
            ...
            <div class="mt-6 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border-l-4 border-amber-400 text-left">
                <h4 class="font-semibold text-amber-800 dark:text-amber-200 mb-2">Important COD Instructions:</h4>
