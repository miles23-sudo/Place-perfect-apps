function filamentGoogleMapsField({
    state,
    defaultLocation,
    controls,
    layers,
    ...
    return {
        ...
        loadGMaps: function () {
            if (
                ...
                let waitForGlobal = function (key, callback) {
                    window[key]
                        ? callback()
                        : setTimeout(function () {
                ...
                (script.id = "filament-google-maps-google-maps-entry-js"),
                    ...
                    (script.src =
                        gmaps + "&callback=filamentGoogleMapsAsyncLoad"),
        ...
        createMap: function () {
            (window.filamentGoogleMapsAPILoaded = !0),
                ...
                geoJson &&
                    ...
                    /^http/.test(geoJson)
                        ...
                        : this.geoJsonDataLayer.addGeoJson(
                              JSON.parse(geoJson)
                          ));
        },
            ...
            return this.dataLayer.add(
                new google.maps.Data.Feature({
                    ...
                    properties: Object.assign(
                        { id: this.guid(), type: overlay.type },
        ...
        transformToMVCArray: function (a) {
            ...
            function transform($a, parent) {
                ...
                for (let a2 = 0; a2 < $a.length; a2++)
                    !Array.isArray($a[a2]) ||
                        transform(
                            $a[a2],
                            parent
                                ? $a[a2].length == 2 &&
                                  !Array.isArray($a[a2][0]) &&
                                  !Array.isArray($a[a2][1])
                                    ? parent
                                    : parent.getAt(
                                          parent.push(
...
export { filamentGoogleMapsField as default };
